...
typedef struct
{
     ...
     *  - UART_I2C_MODE_SLAVE
     *  - UART_I2C_MODE_MASTER
     *  - UART_I2C_MODE_MULTI_MASTER
     *  - UART_I2C_MODE_MULTI_MASTER_SLAVE
    */
    uint32 mode;
...
#define UART_I2C_TX_OVERFLOW_COUNT      (UART_I2C_FIFO_SIZE + 2u)
...
#define UART_I2C_RX_CTRL    ((UART_ONE_BYTE_WIDTH - 1u) | \
                                          UART_RX_CTRL_MSB_FIRST    | \
                                          UART_RX_CTRL_ENABLED)

#define UART_I2C_TX_CTRL    ((UART_ONE_BYTE_WIDTH - 1u) | \
