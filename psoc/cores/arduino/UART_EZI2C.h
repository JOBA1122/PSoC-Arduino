...
****************************************/
    ...
    #define UART_EZI2C_FIFO_SIZE UART_GET_FIFO_SIZE(UART_EZI2C_BYTE_MODE_ENABLE)
...
typedef struct
{
    ...
    */
     ...
     *  - UART_EZI2C_ONE_ADDRESS
     *  - UART_EZI2C_TWO_ADDRESSES
    */
    ...
    */
    ...
    /** Size of sub-address.
     *  - UART_EZI2C_SUB_ADDR8_BITS 
     *  - UART_EZI2C_SUB_ADDR16_BITS
    */
    uint32 subAddrSize;
...
#define UART_EZI2C_TX_CTRL  ((UART_ONE_BYTE_WIDTH - 1u) | \
