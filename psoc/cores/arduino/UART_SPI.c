...
#include "UART_SPI_UART_PVT.h"
    ...
    ****************************************************************************//**
    *
    *  Configures the UART for SPI operation.
    *
    ...
    *  After initializing the UART in SPI mode using this function, 
...
void UART_SpiStop(void)
{
    ...
    if (UART_CHECK_SPI_MASTER)
    {
        ...
        UART_spi_sclk_Write(UART_GET_SPI_SCLK_INACTIVE);

        /* Set GPIO to drive output pin */
        UART_SET_HSIOM_SEL(UART_SCLK_HSIOM_REG, UART_SCLK_HSIOM_MASK,
                                       UART_SCLK_HSIOM_POS, UART_SCLK_HSIOM_SEL_GPIO);
    #endif /* (UART_spi_sclk_PIN) */

    #if (UART_SS0_PIN)
        /* Set output pin state after block is disabled */
        UART_spi_ss0_Write(UART_GET_SPI_SS0_INACTIVE);

        /* Set GPIO to drive output pin */
        UART_SET_HSIOM_SEL(UART_SS0_HSIOM_REG, UART_SS0_HSIOM_MASK,
                                       UART_SS0_HSIOM_POS, UART_SS0_HSIOM_SEL_GPIO);
    #endif /* (UART_spi_ss0_PIN) */
        ...
        /* Set GPIO to drive output pin */
        UART_SET_HSIOM_SEL(UART_SS1_HSIOM_REG, UART_SS1_HSIOM_MASK,
                                       UART_SS1_HSIOM_POS, UART_SS1_HSIOM_SEL_GPIO);
    #endif /* (UART_SS1_PIN) */
        ...
        /* Set GPIO to drive output pin */
        UART_SET_HSIOM_SEL(UART_SS2_HSIOM_REG, UART_SS2_HSIOM_MASK,
                                       UART_SS2_HSIOM_POS, UART_SS2_HSIOM_SEL_GPIO);
    #endif /* (UART_SS2_PIN) */
        ...
        /* Set GPIO to drive output pin */
        UART_SET_HSIOM_SEL(UART_SS3_HSIOM_REG, UART_SS3_HSIOM_MASK,
                                       UART_SS3_HSIOM_POS, UART_SS3_HSIOM_SEL_GPIO);
    #endif /* (UART_SS3_PIN) */
    
        /* Store TX interrupt sources (exclude level triggered) for master. */
        UART_IntrTxMask = LO16(UART_GetTxInterruptMode() & UART_INTR_SPIM_TX_RESTORE);
    }
    else
    {
        /* Store TX interrupt sources (exclude level triggered) for slave. */
        UART_IntrTxMask = LO16(UART_GetTxInterruptMode() & UART_INTR_SPIS_TX_RESTORE);
    }
    ...
    /* Set GPIO to drive output pin */
    UART_SET_HSIOM_SEL(UART_SCLK_M_HSIOM_REG, UART_SCLK_M_HSIOM_MASK,
                                   UART_SCLK_M_HSIOM_POS, UART_SCLK_M_HSIOM_SEL_GPIO);
#endif /* (UART_MISO_SDA_TX_PIN_PIN) */
    ...
    /* Set GPIO to drive output pin */
    UART_SET_HSIOM_SEL(UART_SS0_M_HSIOM_REG, UART_SS0_M_HSIOM_MASK,
                                   UART_SS0_M_HSIOM_POS, UART_SS0_M_HSIOM_SEL_GPIO);
#endif /* (UART_SPI_MASTER_SS0_PIN) */
    ...
    /* Set GPIO to drive output pin */
    UART_SET_HSIOM_SEL(UART_SS1_M_HSIOM_REG, UART_SS1_M_HSIOM_MASK,
                                   UART_SS1_M_HSIOM_POS, UART_SS1_M_HSIOM_SEL_GPIO);
#endif /* (UART_SPI_MASTER_SS1_PIN) */
    ...
    /* Set GPIO to drive output pin */
    UART_SET_HSIOM_SEL(UART_SS2_M_HSIOM_REG, UART_SS2_M_HSIOM_MASK,
                                   UART_SS2_M_HSIOM_POS, UART_SS2_M_HSIOM_SEL_GPIO);
#endif /* (UART_SPI_MASTER_SS2_PIN) */
    ...
    /* Set GPIO to drive output pin */
    UART_SET_HSIOM_SEL(UART_SS3_M_HSIOM_REG, UART_SS3_M_HSIOM_MASK,
                                   UART_SS3_M_HSIOM_POS, UART_SS3_M_HSIOM_SEL_GPIO);
#endif /* (UART_SPI_MASTER_SS3_PIN) */
